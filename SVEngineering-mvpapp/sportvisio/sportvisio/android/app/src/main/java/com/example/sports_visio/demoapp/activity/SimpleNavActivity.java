...
public class SimpleNavActivity extends AppCompatActivity
    ...
    private StreamWebRtcConfigurationFragment streamFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            streamFragment = (StreamWebRtcConfigurationFragment) getSupportFragmentManager().findFragmentByTag(StreamWebRtcConfigurationFragment.class.getName());
        }
        // Video only
            ...
            public void onError(Exception e) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(SimpleNavActivity.this, "User sign-in error: " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
            }
        }));

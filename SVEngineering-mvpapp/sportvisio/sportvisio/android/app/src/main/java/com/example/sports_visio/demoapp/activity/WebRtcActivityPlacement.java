...
public class WebRtcActivityPlacement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_web_rtc_placement);
...
//            });
            ...
            final Dialog dialog = new Dialog(WebRtcActivityPlacement.this,android.R.style.Theme_Black_NoTitleBar_Fullscreen);
...
//        addStreamToLocalPeer();
    ...
    void attachDeviceStream() {
        ...
        RequestBody requestBody = new FormBody.Builder()
                .add("videoId",registerdevicid )
                .add("startTime", startTimeStamp)
                .add("endTime",  endTimeStamp)
                .add("deviceId",deviceId+"12")
                .add("gameId",registergameid)
    ...
    void startStreamProcessing() {
        Request request = new Request.Builder()
                .url(ApiEndpoints.START_STREAM + "/" + Settings.Secure.getString(getContentResolver(),
                        Settings.Secure.ANDROID_ID))
                .build();
        okHttpClient.newCall(request).enqueue(new okhttp3.Callback() {
            @Override
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                WebRtcActivityPlacement.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
//                        txtString.setText(myResponse);
    ...
    void stopStreamProcessing() {
        Request request = new Request.Builder()
                .url(ApiEndpoints.STOP_STREAM + "/" + Settings.Secure.getString(getContentResolver(),
                        Settings.Secure.ANDROID_ID))
                .build();

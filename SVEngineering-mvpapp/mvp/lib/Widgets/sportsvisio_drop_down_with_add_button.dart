...
class SportsVisioDropDownWithAddButton<T> extends StatelessWidget {
  ...
  SportsVisioDropDownWithAddButton({
    Key? key,
          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: DropdownSearch<T>(
                ...
                validator: (response) => searchBoxController.text.isNotEmpty ? null : "Required",

...
import 'package:sportvisio/network/api_exception.dart';
import 'package:sportvisio/network/api_response.dart';

@lazySingleton
class ApiHelper {
  final String baseUrl = ApiEndPoints.BASE_URL;
  final String baseUrlSwagger = "https://dev.sportsvisio-api.com/";
  ...
  Future<dynamic> get(String uri,
      ...
      bool useSwagger = false}) async {
    try {
      var response = await _dio.get(
        (useSwagger ? baseUrlSwagger : baseUrl) + uri,

...
class customSearchDropdown extends StatelessWidget {
  ...
  var onTapAdd;
  var hint;
  DropdownSearchOnFind<String>? onFind;
  customSearchDropdown(this._list, this.onChanged,
      {this.selectedItem, this.isAdd, this.onTapAdd, this.onFind, this.hint});
          ...
          child: Container(
            ...
            child: SizedBox(
              child: DropdownSearch<String>(
                ...
                searchBoxDecoration:
                    InputDecoration(hintText: hint != null ? hint : ''),
                items: _list,
                itemAsString: (String u) => u,
                onChanged: onChanged,
                onFind: onFind != null ? onFind : null,
              ),
            ),
          ),
        )),
        Container(
          width: isAdd != null ? 40 : 0,
          height: isAdd != null ? 40 : 0,

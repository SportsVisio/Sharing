...
aws cloudwatch put-metric-data --metric-name $CW_METRIC --namespace $CW_NAMESPACE --unit None --value $MyBacklogPerWorker --dimensions SQS-Queue=GetHighlightsEvents.fifo
